                ...
                <?php if(!empty($rows1)):?>
                  <?php foreach($rows1 as $row):?>
                    <div class="post-entry-1">
                      ...
                      <div class="post-meta"><span class="date"><?=esc($row->category_row->category ?? 'Категория не задана')?></span> <span class="mx-1">&bullet;</span> <span><?=get_date($row->date)?></span></div>
